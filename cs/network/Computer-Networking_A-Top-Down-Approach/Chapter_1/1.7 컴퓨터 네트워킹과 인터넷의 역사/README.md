...
1980년대 말까지 오늘날의 인터넷과 유사한 네트워크 연합인 공중 인터넷에 연결된 호스트 수는 십만 개에 이르렀다.  

<br/>

1980년 대에는 거대한 성장 시대였다고 말할 수 있다.
- BITNET은 북동지역의 여러 대학 사이에 전자메일과 파일 전송을 제공했다.
- CSNET은 ARPAnet에 접속하지 않고 대학 연구자들을 연결하기 위해 만들어 졌다.
- NSFNET은 1986년에 설립되었고, 지역 네트워크를 연결하는 주요 백본이 되었다.
- ARPAnet 커뮤니티에서 1983년 1월 1일 TCP/IP(NCP 프로토콜을 대체)가 공식 설치되었다.
- 도메인 네임 시스템도 개발 되었다.
